...
def compute_bleu(reference_texts: str, candidate_texts: str) -> float:
    reference = [reference_texts.split()]  # BLEU expects a list of reference sentences, each split into words
    candidate = candidate_texts.split()  # Candidate sentence split into words
...
def plot_results(summary_data, mitigation_data):
    import pandas as pd
    import seaborn as sns
    import matplotlib.pyplot as plt
...
if __name__ == "__main__":
    summary_file = "./results/new_final_evals_ProveRAG_exploitation_main.json"  # Replace with your actual file path
    mitigation_file = "./results/new_final_evals_ProveRAG_mitigation_main.json"  # Replace with your actual file path
    main(summary_file, mitigation_file)
